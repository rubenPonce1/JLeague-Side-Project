...
export default function Gamba(){
  return(
    <div className='gamba'>
      <h1 className='header'> <img src={Gamba_Osaka} alt = "logo"className ="team-logo"></img>
        Gamba Osaka
      </h1>
        ...
        <div className='team-info-wrapper'>
          ...
          <div className='info-item'>Team names: </div>
            <div className='info-value'>
              Matsushita Electric SC (1980)<br/>
              Gamba Osaka (1992) <br/>
            ...
            <div className='info-item'>Accomplishments: </div>
              <div className='info-value'>
                Matsushita Electric SC: <br/>
                  All Japan Senior Football Championship (1983)<br/>
                  JSL Division 2 (1985)<br/>
                  Emperor's Cup (1990)<br/>
                  <br/>
                
                Gamba Osaka <br/>
                  J.League Division 1 (2005,2014) <br/>
                  J.League Division 2 (2013) <br/>
                  Emperor's Cup (2008, 2009, 2014, 2015)<br/>
                  J.League Cup (2007, 2014)<br/>
                  Japanese Super Cup (2007, 2015) <br/>
                  AFC Champions League (2008) <br/>
                  Pan-Pacific Championship (2008)<br/>
                  <br/>
              </div>
