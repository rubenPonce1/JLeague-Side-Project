    ...
    <div className="albi">
      ...
      <div className="team-info">
        <div className="team-info-wrapper">
          ...
          <div className="info-value">
            ...
            Capacity: 42,300
            <br />
            <i class="fas fa-map-marker-alt"> </i> Chuo-ku, Niigata
            <br />
          </div>

          <div className="info-item">Accomplishments: </div>
          <div className="info-value">
            Niigata Eleven SC: <br />
            &emsp; Hokushinetsu Football League (1986)
            <br />
            Albirex Niigata: <br />
            &emsp; J2 Champion (2003, 2022) <br />
            &emsp; Hokushinetsu Football League (1996, 1997)
          </div>
        </div>
      </div>
      ...
      <Container className="video-cntr">
        ...
        <div class="ratio ratio-16x9">
          <iframe
            src="https://www.youtube.com/embed/8CkmtM6R45M?si=6KHMyIp5bpOL3UAw"
            title="YouTube video"
            allowFullScreen
          ></iframe>
        </div>
        ...
        <div className="video-disc">
          ...
          Title: Meiji Yasuda Life J2 League championship and J1 promotion
